package com.greatlearning.labsession.UI;

import java.util.Scanner;

import com.greatlearning.labsession.App.Employee;
import com.greatlearning.labsession.Service.CredentialGeneration;
...
public class EmailApplicationUI {
	...
	private void callService(Employee employee) {
		...
		CredentialGeneration generator = new CredentialGeneration(employee);
