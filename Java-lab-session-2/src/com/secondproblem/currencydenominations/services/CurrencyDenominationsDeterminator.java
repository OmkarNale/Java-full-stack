package com.secondproblem.currencydenominations.services;
...
public class CurrencyDenominationsDeterminator {
	...
	private void printErrorMessage() {
		...
		System.out.println("For the denomination values "+ DataStructureUtils.printAndReturn(denominations) +", it is not possible to give for the payment amount ["+ 
						payAmount + "]");
	}
