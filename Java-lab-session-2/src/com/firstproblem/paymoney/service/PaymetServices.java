package com.firstproblem.paymoney.service;
...
public class PaymetServices {
	...
	public PaymetServices(int[] transactions, int dailyTarget) {
	...
	private static void test(int[] transactions, int dailyTarget) {
		...
		PaymetServices calculator = new PaymetServices(transactions, dailyTarget);
